...
public partial class JSB_Photo_New_Account_Manage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM New_Account_User", connection);
    ...
    protected void TextBox2_TextChanged(object sender, EventArgs e)
    {
        ...
        string q = "SELECT *FROM New_Account_User Where AccountNumber like'%" + TextBox2.Text + "%'";
        cmd.CommandText = q;
        cmd.Connection = conn;
